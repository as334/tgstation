...
/datum/gas_reaction/plasmanimusformation/
	priority = 10
	name = "Animated Plasma formation"
	id = "plasmanimusformation"

/datum/gas_reaction/plasmanimusformation/init_reqs()
	min_requirements = list(
		/datum/gas/bz = 20, //Change to Miasma if that gets merged
		/datum/gas/hypernoblium = 1,
		/datum/gas/plasma = 200,
		"TEMP" = 50000000)

/datum/gas_reaction/plasmanimusformation/react(datum/gas_mixture/air)
	var/list/cached_gases = air.gases
	air.assert_gases(/datum/gas/plasmanimus)
	cached_gases[/datum/gas/plasmanimus]+= 1//Temporary till I come up with a good synthesis method
